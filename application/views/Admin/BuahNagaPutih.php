                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    <ul class="list-unstyled">
                                        <li class="pb-2"><strong>Kingdom: </strong> Plantae</li>
                                        <li class="pb-2"><strong>Divisi : </strong>Spermatophyta</li>
                                        <li class="pb-2"><strong>Subdivisi : </strong> Angiospermae</li>
                                        <li class="pb-2"><strong>Kelas : </strong>Dicotyledonae</li>
                                    </ul>
                                </div>
                                <div class="col-lg-6">
                                    <ul class="list-unstyled">
                                        <li class="pb-2"><strong>Ordo : </strong> Cactales</li>
                                        <li class="pb-2"><strong>Famili : </strong> Cactaceae</li>
                                        <li class="pb-2"><strong>Genus : </strong> Hylocereus </li>
                                        <li class="pb-2"><strong>Spesies : </strong> Hylocereus cistericensi, Hylocereus undarus, Hylocereus polyrhizus, selenicereus megalanthus </li>
